...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 23, 2018 at 05:11 PM
...
CREATE TABLE `asset_details` (
  ...
  `item_quantity` varchar(4) NOT NULL,
  `item_name` varchar(20) NOT NULL,
  `item_category` varchar(20) NOT NULL,
  `item_description` varchar(100) NOT NULL,
  `item_status` varchar(15) NOT NULL,
  `lab_bo` varchar(3) NOT NULL,
  `cost` varchar(7) NOT NULL,
  `grr_no` varchar(35) NOT NULL,
...
CREATE TABLE `lab_details` (
  `lab_no` varchar(3) NOT NULL,
  `lab_incharge` varchar(30) NOT NULL,
  `lab_assistant` varchar(30) NOT NULL,
...
CREATE TABLE `vendor_details` (
  ...
  `vendor_contact` varchar(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
